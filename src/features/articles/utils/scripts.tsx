 ...
 */
export const getQueryString = (queryParams: Record<string, string| number|boolean>) => {
  return Object.entries(queryParams).map(([key, value]) => `${encodeURIComponent(key)}=${encodeURIComponent(value)}`).join('&');
}